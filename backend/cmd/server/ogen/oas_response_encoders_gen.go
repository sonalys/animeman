...
func encodeTransferClientsGetResponse(response []TransferClient, w http.ResponseWriter, span trace.Span) error {
	if err := func() error {
		if response == nil {
			return errors.New("nil is invalid value")
		}
...
func encodeTransferClientsPostResponse(response *TransferClientsPostCreated, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(201)
	span.SetStatus(codes.Ok, http.StatusText(201))
