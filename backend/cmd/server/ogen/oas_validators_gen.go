...
func (s *Authentication) Validate() error {
	if s == nil {
...
func (s *AuthenticationNone) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s AuthenticationNoneType) Validate() error {
	switch s {
	case "none":
		return nil
	default:
...
func (s *SetupGetOK) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
	...
	if err := func() error {
		...
		var failures []validate.FieldError
		for i, elem := range s.CompletedSteps {
			if err := func() error {
				if err := elem.Validate(); err != nil {
					return err
				}
	...
	if err := func() error {
		if s.MissingSteps == nil {
			return errors.New("nil is invalid value")
		}
		var failures []validate.FieldError
		for i, elem := range s.MissingSteps {
			if err := func() error {
				if err := elem.Validate(); err != nil {
					return err
				}
...
func (s SetupSteps) Validate() error {
	switch s {
	case "watchlist":
		return nil
	case "indexing":
